/*
 ...
 MyFonts Webfont Build ID 3666470, 2018-11-03T11:56:17-0400
 ...
 Webfont: Santral-Light by Taner Ardali
 URL: https://www.myfonts.com/fonts/taner-ardali/santral/light/
 Copyright: Copyright (c) 2016 by Taner Ardal&#x0131;. All rights reserved.
 Licensed pageviews: Unlimited


 License: https://www.myfonts.com/viewlicense?type=web&buildid=3666470
...
for(var fonts=[{fontFamily:"Santral-Light",url:wfpath+"37F226_0"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+";");fonts[i].fontWeight&&(css+="font-weight: "+fonts[i].fontWeight+";");fonts[i].fontStyle&&(css+="font-style: "+fonts[i].fontStyle+";");css+=
